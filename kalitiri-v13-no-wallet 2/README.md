...
## v12 — Cinematic card animations

- Added smoother 3D card dealing, card launch/play, table landing, active-seat glow and trick-winner effects.
- Kept the 60-second action timer and Android/Capacitor fixes.
- No wallet, virtual rupees, deposits, rewards or cash features are included.
